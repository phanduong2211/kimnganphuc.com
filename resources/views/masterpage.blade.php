            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li id='menu_home'><a href="{{asset('')}}">Home</a></li>
                        <li id='menu_about'><a href="about-us.html">About Us</a></li>
                        <li id='menu_service'><a href="services.html">Services</a></li>
                        <li id='menu_portfolio'><a href="portfolio.html">Portfolio</a></li>
                        <!-- <li id='menu_pages' class="dropdown">
                        ...
                        <li id='menu_blog'><a href="blog.html">Blog</a></li> 
                        <li id='menu_contact'><a href="contact-us.html">Contact</a></li>                        
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
